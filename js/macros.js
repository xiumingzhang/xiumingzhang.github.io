...
const DISSERTATION_PDF =
  'https://drive.google.com/file/d/1-cUlfdSXbekzRZB4FO3OEmdSi3i-MoaT/view';
...
const MOSCULP_FORBES =
  'https://www.forbes.com/sites/jenniferhicks/2018/09/25/these-researchers-turned-2d-videos-into-3d-motion-sculptures';
const MOSCULP_BBC =
  'https://www.bbc.com/news/av/technology-45552015/creating-3d-sculptures-from-2d-video-and-other-news';
const MOSCULP_MIT =
...
const AD_NUS =
  'http://news.nus.edu.sg/highlights/model-illuminates-alzheimers-disease';
const AD_PT =
  'https://www.psychologytoday.com/intl/blog/the-athletes-way/201610/alzheimers-study-links-triad-brain-areas-cognition';
...
function clickable(text, link) {
  document.write(
    "<a class='lowkey' target='_blank' href=" + link + '>' + text + '</a>'
  );
}
...
function getPerson(id) {
  switch (id) {
    ...
    case 'rhemann':
      clickable(
        'Christoph Rhemann',
        'https://scholar.google.com/citations?user=5D0_pjcAAAAJ'
      );
      break;
    case 'debevec':
    ...
    case 'yunta':
      clickable(
        'Yun-Ta Tsai',
        'https://scholar.google.com/citations?user=7fUcF9UAAAAJ'
      );
      break;
    case 'pratul':
      clickable(
    ...
    case 'yeo':
      clickable(
        'B. T. Thomas Yeo',
        'https://sites.google.com/view/yeolab/thomas'
      );
      break;
    case 'jiayuan':
    ...
    case 'yikai':
      clickable(
        'Yikai Li',
        'https://scholar.google.com/citations?user=0EVzwD8AAAAJ'
      );
      break;
    case 'tenenbaum':
    ...
    case 'siyi':
      clickable(
        'Siyi Tang',
        'https://scholar.google.com/citations?user=dpRSfnoAAAAJ'
      );
      break;
    case 'nanbo':
      clickable(
        'Nanbo Sun',
        'https://scholar.google.com.sg/citations?user=odaBvWAAAAAJ'
      );
      break;
    case 'mormino':
      clickable(
        'Elizabeth C. Mormino',
        'https://med.stanford.edu/profiles/elizabeth-mormino'
      );
      break;
    case 'zhoutong':
    ...
    case 'chengkai':
      clickable(
        'Chengkai Zhang',
        'https://scholar.google.com/citations?user=rChGGwgAAAAJ'
      );
      break;
    case 'dekel':
    ...
    case 'qiurui':
      clickable(
        'Qiurui He',
        'https://scholar.google.com/citations?user=BxqV_RsAAAAJ'
      );
      break;
    case 'mueller':
    ...
    case 'sperling':
      clickable(
        'Reisa A. Sperling',
        'https://www.nmr.mgh.harvard.edu/user/5647'
      );
      break;
    case 'sabuncu':
    ...
    case 'holynski':
      clickable(
        'Aleksander Holynski',
        'https://homes.cs.washington.edu/~holynski/'
      );
      break;
    case 'liyuan':
      clickable(
        'Liyuan Li',
        'https://scholar.google.com/citations?user=_R7z25AAAAAJ'
      );
      break;
    case 'steven':
...
function getVenue(id) {
  switch (id) {
    ...
    case 'uist':
      clickable(
        'UIST',
        'https://en.wikipedia.org/wiki/ACM_Symposium_on_User_Interface_Software_and_Technology'
      );
      break;
    case 'eccv':
      clickable(
    ...
    case 'ismrm':
      clickable(
        'ISMRM',
        'https://en.wikipedia.org/wiki/International_Society_of_Magnetic_Resonance_in_Medicine'
      );
      break;
    default:
      undef();
